...
let viewVCE_envs = {
    ...
    setGain: function (osc /* zero-based */, gain /*0..100*/, lowup /*0 or 1*/) {
        // this can be called for an OSC whose controls are not actually visible (it's
    ...
    raw_onchange: function (ele, extraarg) {
        if (viewVCE.supressOnchange) { /*console.log("raw viewVCE.suppressOnChange");*/
            return;
        }
        if (viewVCE_envs.supressOnchange) { /*console.log("raw viewVCE_envs.suppressOnChange");*/
