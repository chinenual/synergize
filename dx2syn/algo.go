...
var dxAlgoNoFeedbackPatchTypePerOscTable = [32][16]byte{
	...
	{100, 161, 100, 145, 148, 2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}, // DX 16 (algo 15) //FIXME: uses invalid registers
	{100, 161, 100, 145, 148, 2, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4}, // DX 17 (algo 16) //FIXME: uses invalid registers
